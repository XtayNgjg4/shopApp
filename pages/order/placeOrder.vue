	...
	<view>
		...
		<navigator url="/pages/address/address?source=1" class="address-section">
			<view class="order-content">
				<text class="icon icon-shouhuodizhi"></text>
				<view class="cen">
					<view class="top">
		...
		<view class="goods-section">
			<view class="g-header b-b">
				...
				<text class="name">快乐小店</text>
			</view>
			<!-- 商品列表 -->
			<view class="g-item">
				<image src="https://a.appsimg.com/upload/merchandise/pdcvis/2019/08/19/43/947d2cba-02b3-465a-b645-d1ab2f0091ad_360x456_100.jpg!75.webp"></image>
				<view class="right">
					<view class="title clamp">女夏装2019新款</view>
			...
			<view class="g-item">
				<image src="https://a.appsimg.com/upload/merchandise/pdcvis/615409/2019/0808/55/7be13ffa-d5c6-422d-9285-28214c6df8e9_360x456_100.jpg!75.webp"></image>
				<view class="right">
