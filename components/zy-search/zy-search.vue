<template name="zy-search">
	<view>
		<view class="search">
			<!-- #ifdef APP-PLUS -->
				<image src="../../static/images/searchicon/voice.svg" mode="aspectFit" @click="startRecognize()" class="voice-icon"></image>
			<!-- #endif -->
			...
			<image src="../../static/images/searchicon/search.svg" mode="aspectFit" @click="searchStart()" class="search-icon"></image>
		</view>
		<template v-if="isBlock">
			<view class="s-block" v-if="hList.length > 0">
				<view class="header">
					历史记录
					<image src="../../static/images/searchicon/delete.svg" mode="aspectFit" @click="delhistory"></image>
				</view>
				<view class="list">
